...
Please meet the minimum version of the Go language published in [go.mod](https://github.com/kubecub/feishu-sheet-parser/tree/main/go.mod). If you want to manage the Go language version, we provide tools to install [gvm](https://github.com/moovweb/gvm) in our [Makefile](./Makefile)
...
Every action to make project feishu-sheet-parser better is encouraged. On GitHub, every improvement for feishu-sheet-parser could be via a [PR](https://github.com/kubecub/feishu-sheet-parser/pulls) (short for pull request).
...
+ [README_zh-CN.md](https://github.com/kubecub/feishu-sheet-parser/blob/main/README_zh-CN.md): This file includes the basic information and instructions for getting started with OpenIM in Chinese.
...
+ [Official Documentation](https://nsddd.top): This is the official documentation for feishu-sheet-parser, which includes comprehensive information on all of its features, configuration options, and troubleshooting tips.
...
+ help review other's [PR](https://github.com/kubecub/feishu-sheet-parser/pulls) design; 
+ discuss about feishu-sheet-parser to make things clearer;
+ advocate [feishu-sheet-parser](https://google.com/search?q=feishu-sheet-parser) technofeishu-sheet-parsery beyond GitHub;
